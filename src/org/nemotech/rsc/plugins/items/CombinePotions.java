...
public class CombinePotions implements InvUseOnItemListener, InvUseOnItemExecutiveListener {
    ...
    public void onInvUseOnItem(Player p, InvItem item1, InvItem item2) {
        ...
        if (item1.getID() == 224 && item2.getID() == 223 || item1.getID() == 223 && item2.getID() == 224) {
            if (p.getInventory().remove(new InvItem(224)) > -1 && p.getInventory().remove(new InvItem(223)) > -1) {
                addItem(p, 222, 1);
        ...
        // 1 dose on 3 dose = 4 dose
            ...
            if (p.getInventory().remove(new InvItem(224)) > -1 && p.getInventory().remove(new InvItem(222)) > -1) {
                addItem(p, 221, 1);
        ...
        // 2 dose on 2 dose = 4 dose
            ...
            if (p.getInventory().remove(new InvItem(223)) > -1 && p.getInventory().remove(new InvItem(223)) > -1) {
                addItem(p, 221, 1);
        ...
        // 1 dose on 1 dose = 2 dose
            ...
            if (p.getInventory().remove(new InvItem(224)) > -1 && p.getInventory().remove(new InvItem(224)) > -1) {
                addItem(p, 223, 1);
        ...
        // 3 dose on 3 dose = 6 dose (one 4 dose full pot, one 2 dose pot)
            ...
            if (p.getInventory().remove(new InvItem(222)) > -1 && p.getInventory().remove(new InvItem(222)) > -1) {
        ...
        /** Rest of the potions in the game **/
            ...
            for (int i = 0; i < combinePotions.length; i++) {
                ...
                if ((item1.getID() == combinePotions[i][0] && item2.getID() == combinePotions[i][1]) || (item2.getID() == combinePotions[i][0] && item1.getID() == combinePotions[i][1])) {
                    if (p.getInventory().remove(new InvItem(combinePotions[i][0])) > -1 && p.getInventory().remove(new InvItem(combinePotions[i][1])) > -1) {
                        p.message("You combine 2 doses of " + item1.getDef().getName().toLowerCase() + " with 1 dose of " + item2.getDef().getName().toLowerCase());
                        p.getInventory().add(new InvItem(combinePotions[i][2])); // 1 full pot
                ...
                /** 1 dose with 1 dose. **/
                    ...
                    if (p.getInventory().remove(new InvItem(combinePotions[i][1])) > -1 && p.getInventory().remove(new InvItem(combinePotions[i][1])) > -1) {
                        p.message("You combine two 1 dose of " + item1.getDef().getName().toLowerCase());
                        p.getInventory().add(new InvItem(combinePotions[i][0])); // 2 dose pot
                ...
                /** 2 dose with 2 dose. **/
                    ...
                    if (p.getInventory().remove(new InvItem(combinePotions[i][0])) > -1 && p.getInventory().remove(new InvItem(combinePotions[i][0])) > -1) {
                        p.message("You combine two 2 doses of " + item1.getDef().getName().toLowerCase());
                        p.getInventory().add(new InvItem(combinePotions[i][2])); // 1 full pot
                        p.getInventory().add(new InvItem(combinePotions[i][1])); // 1 dose pot
