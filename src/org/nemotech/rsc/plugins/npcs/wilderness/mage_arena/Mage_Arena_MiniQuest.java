...
//
//import org.nemotech.rsc.engine.event.DelayedEvent;
//import static org.nemotech.rsc.plugins.Plugin.*;
//import org.nemotech.rsc.model.container.InvItem;
//import org.nemotech.rsc.model.entity.GameObject;
//import org.nemotech.rsc.model.entity.Item;
//import org.nemotech.rsc.model.entity.Mob;
//import org.nemotech.rsc.model.entity.npc.Npc;
//import org.nemotech.rsc.model.entity.player.Player;
//import org.nemotech.rsc.model.world.World;
//
...
////import org.nemotech.rsc.plugins.listeners.executive.PlayerDeathExecutiveListener;
...
//
//public class Mage_Arena_MiniQuest extends Plugin implements TalkToNpcExecutiveListener, TalkToNpcListener, PlayerKilledNpcListener,
...
//                  return;
//              }
//              if (p.getSkills().getLevel(Skills.ATTACK) > 0 || p.getSkills().getLevel(Skills.STRENGTH) > 0) {
...
//              if (Guthix != null && Guthix.withinRange(p, 1)) {
//                  godSpellObject(p, 33);
//                  p.message(randomMessage[2]);
//                  if(getCurrentLevel(p, HITS) < 20) {
//                      p.damage(2);
//                  } else {
//                      p.damage(getCurrentLevel(p, HITS) / 10);
//                  }
//              } else if (Zamorak != null && Zamorak.withinRange(p, 1)) {
//                  godSpellObject(p, 35);
...
//                      p.damage(getCurrentLevel(p, HITS) / 10);
//                  }
//              } else if (Saradomin != null && Saradomin.withinRange(p, 1)) {
//                  godSpellObject(p, 34);
...
//          @Override
//          public void run() {
//              Npc npc = p.getAttribute("spawned_kolodion");
//              if (npc == null) {
//                  return;
//              }
//              /* Player logged out. */
...
//              npcYell(p, npc, randomMessage[random(0, randomMessage.length - 1)]);
//              p.damage(random(3, 13));
//
//          }
//      };
//      if (kolE != null) {
...
//          }
//      }
//      for (InvItem item : player.getBank().getItems()) {
//          if (item.getID() == 1213 || item.getID() == 1214 || item.getID() == 1215) {
//              return true;
//          }
//      }
...
//          } else {
//              InvItem Item = new InvItem(i.getID(), i.getAmount());
