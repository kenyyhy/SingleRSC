...
public class DwarfCannon
    ...
    private final Shop shop = new Shop("Nulodion's Cannon Parts", false, 3000, 100, 70, 2, new InvItem(1032, 3), new InvItem(1033, 3), new InvItem(1034, 3),
            new InvItem(1035, 3), new InvItem(1073, 7), new InvItem(1057, 7));

    @Override
    public int getQuestID() {
        return Plugin.DWARF_CANNON;
    }
    ...
    public void handleReward(Player p) {
        p.incQuestExp(12, p.getMaxStat(12) * 50 + 250);
        p.incQuestPoints(1);
            ...
            case -1:
                ...
                if (completeMenu == 0) {
                    ...
                    if (p.getCache().hasKey("cannon_stage") && p.getCache().hasKey("cannon_x")
                        ...
                        GameObject cannon = null;//RegionManager.getRegion(cannonX, cannonY).getGameObject(cannonX, cannonY);
                        ...
                        if (cannon == null) {// || !DataConversions.inArray(Cannon.cannonObjectIDs, cannon.getID())) {
                            ...
                            switch (cannonStage) {
                            case 1:
                                p.getInventory().add(new InvItem(1032));
                                break;
                            case 2:
                                p.getInventory().add(new InvItem(1032));
                                p.getInventory().add(new InvItem(1033));
                                break;
                            case 3:
                                p.getInventory().add(new InvItem(1032));
                                p.getInventory().add(new InvItem(1033));
                                p.getInventory().add(new InvItem(1034));
                                break;
                            case 4:
                                p.getInventory().add(new InvItem(1032));
                                p.getInventory().add(new InvItem(1033));
                                p.getInventory().add(new InvItem(1034));
                                p.getInventory().add(new InvItem(1035));
                                break;
                            }
        ...
        if (n.getID() == 771) {
            ...
            case 6:
                if (hasItem(p, 1056) && hasItem(p, 1057)) {
                    ...
                    p.sendQuestComplete(Plugin.DWARF_CANNON);
                } else {
    ...
    private boolean failToReplace() {
        int poisonChance = Util.random(0, 100);
        if (poisonChance > 75) {
            return true;
        }
        return false;
        ...
        if (obj.getID() == 994) {
            ...
            if (failToMultiCannon()) {
                ...
                if (cannonMenu == 0) {
                    ...
                    showBubble(player, new InvItem(1055));
                    if (failToMultiCannon()) {
