...
//import org.nemotech.rsc.plugins.listeners.action.PlayerMageObjectListener;
        ...
        if(obj.getID() == DARK_METAL_GATE) {
            if(command.equalsIgnoreCase("open")) {
                ...
                if(menu == 0) {
                    ...
                    p.getSender().sendAlert("Gates of metal will not be kind, % %To those who care not for the way of mind. % %To all men of learning and supernatural powers, % %With book and rune spend the long dark hours. % %If passage further you would endure, % %Give me a taste of your power so pure. % %", true);
                } else if(menu == 1) {
