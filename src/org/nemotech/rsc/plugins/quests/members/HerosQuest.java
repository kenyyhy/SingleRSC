...
import static org.nemotech.rsc.plugins.quests.free.ShieldOfArrav.BLACK_ARM;
...
TalkToNpcExecutiveListener, PickupExecutiveListener, WallObjectActionListener, WallObjectActionExecutiveListener, InvUseOnWallObjectListener, InvUseOnWallObjectExecutiveListener, ObjectActionListener, ObjectActionExecutiveListener, PlayerAttackNpcExecutiveListener, PlayerAttackNpcListener, PlayerRangeNpcListener, PlayerMageNpcListener, PlayerRangeNpcExecutiveListener, PlayerMageNpcExecutiveListener  {
    ...
    public void handleReward(Player player) {
        ...
        player.incQuestExp(0, (player.getMaxStat(0) * 50) + 75);//ATTACK
        player.incQuestExp(1, (player.getMaxStat(1) * 50) + 75);//DEFENSE
        player.incQuestExp(3, (player.getMaxStat(3) * 50) + 75);//HITS
        player.incQuestExp(2, (player.getMaxStat(2) * 50) + 75);//STRENGTH
        
        player.incQuestExp(7, (player.getMaxStat(7) * 50) + 75);//COOKING
        player.incQuestExp(10, (player.getMaxStat(10) * 50) + 75);//FISHING
        player.incQuestExp(14, (player.getMaxStat(14) * 50) + 75);//MINING
        player.incQuestExp(13, (player.getMaxStat(13) * 50) + 75);//SMITHING
        player.incQuestExp(4, (player.getMaxStat(4) * 50) + 75);//RANGED
        player.incQuestExp(11, (player.getMaxStat(11) * 50) + 75);//FIREMAKING
        player.incQuestExp(8, (player.getMaxStat(8) * 50) + 75);//WOODCUT
        player.incQuestExp(15, (player.getMaxStat(15) * 50) + 75);//HERBLAW
    ...
    public void onTalkToNpc(Player p, NPC n) {
        ...
        if(n.getID() == 253) {
            ...
            case 0:
                ...
                if(opt == 0) {
                    if((p.getQuestStage(Plugin.LOST_CITY) == -1 && 
                            p.getQuestStage(Plugin.SHIELD_OF_ARRAV) == -1 && 
                            p.getQuestStage(Plugin.MERLINS_CRYSTAL) == -1 && 
                            p.getQuestStage(Plugin.DRAGON_SLAYER) == -1) // probably bluffing.
                            && p.getQuestPoints() >= 55) {              
            ...
            case 2:
                ...
                if(hasItem(p, 586) && hasItem(p, 590) && hasItem(p, 557)) {
                    ...
                    removeItem(p, 590, 1);
                    removeItem(p, 557, 1);
                    p.sendQuestComplete(Plugin.HEROS_QUEST);
                } else {
