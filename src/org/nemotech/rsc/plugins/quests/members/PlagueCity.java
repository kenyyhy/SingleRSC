...
ObjectActionExecutiveListener {
    ...
    public void handleReward(Player p) {
        ...
        p.incQuestExp(14, (75 * p.getMaxStat(14)) + 175);
        p.incQuestPoints(1);
    ...
    public void onTalkToNpc(Player p, NPC n) {
        ...
        if (n.getID() == 437) {
            ...
            case 11:
                ...
                p.sendQuestComplete(Plugin.PLAGUE_CITY);
    ...
    public void onObjectAction(GameObject obj, String command, Player p) {
        ...
        if (obj.getID() == 449) {
            if(p.getQuestStage(this) == -1 && p.getQuestStage(Plugin.BIOHAZARD) != -1) {
                return;
            }
            if(p.getQuestStage(this) == -1 && p.getQuestStage(Plugin.BIOHAZARD) == -1) {
