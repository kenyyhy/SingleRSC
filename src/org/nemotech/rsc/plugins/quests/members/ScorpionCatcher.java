...
WallObjectActionExecutiveListener {
    ...
    public int getQuestID() {
        return Plugin.SCORPION_CATCHER;
    }
        ...
        if (n.getID() == THORMAC) {
            ...
            case 2:
                ...
                if(!hasItem(p, 678) && !hasItem(p, 681)) {
                    ...
                    p.sendQuestComplete(Plugin.SCORPION_CATCHER);
                } else {
            ...
            case -1:
                ...
                if (four == 1) {
                    ...
                    if (five == 0) {
                        ...
                        if(removeItem(p, new InvItem(10, 40000), new InvItem(615,1)))  {
                            addItem(p, 682, 1);
                        ...
                        if(removeItem(p, new InvItem(10, 40000), new InvItem(616,1)))  {
                            addItem(p, 683, 1);
                            p.message("Thormac enchants your staff");
                        }
                    } else if (five == 2) {
                        ...
                        if(removeItem(p, new InvItem(10, 40000), new InvItem(617,1)))  {
                            addItem(p, 684, 1);
                            p.message("Thormac enchants your staff");
                        }
                    } else if (five == 3) {
                        ...
                        if(removeItem(p, new InvItem(10, 40000), new InvItem(618,1)))  {
                            addItem(p, 685, 1);
                            p.message("Thormac enchants your staff");
                        }
                    }
    ...
    @Override
    public boolean blockInvUseOnNpc(Player player, NPC n, InvItem i) {
    ...
    @Override
    public void onInvUseOnNpc(Player p, NPC n, InvItem i) {
    ...
    @Override
    public boolean blockInvUseOnWallObject(GameObject obj, InvItem item,
            Player player) {
