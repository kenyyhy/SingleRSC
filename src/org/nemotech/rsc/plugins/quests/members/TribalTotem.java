...
public class TribalTotem implements QuestInterface,TalkToNpcListener,
    ...
    public void handleReward(Player p) {
        ...
        p.incQuestExp(17, (75 * p.getMaxStat(17)) + 200); // THIEVING XP.
        ...
        if (n.getID() == 332) {
            ...
            case 2:
                ...
                if (p.getInventory().countId(705) >= 1) {
                    ...
                    p.sendQuestComplete(Plugin.TRIBAL_TOTEM);
        ...
        if (n.getID() == 334) {
            ...
            if (p.getCache().hasKey("label") && p.getQuestStage(this) == 1) {
                ...
                if (menu == 0) {
                    ...
                    n.teleport(558, 616);
                    GameObject obj = World.getWorld().getTile(Point.getLocation(558, 617)).getGameObject();
