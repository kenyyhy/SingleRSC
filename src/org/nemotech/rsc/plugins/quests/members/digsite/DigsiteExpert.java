...
public class DigsiteExpert implements QuestInterface, TalkToNpcListener, TalkToNpcExecutiveListener, InvUseOnNpcListener, InvUseOnNpcExecutiveListener {
    ...
    public void handleReward(Player player) {
        ...
        player.incQuestExp(MINING, 300 * (player.getCurStat(MINING) + 1));
        player.incQuestExp(HERBLAW, 125 * (player.getCurStat(HERBLAW) + 1));
    ...
    @Override
    public boolean blockInvUseOnNpc(Player p, NPC n, InvItem i) {
        if(n.getID() == EXPERT) {
            return true;
        }
        return false;
    ...
    public void onInvUseOnNpc(Player p, NPC n, InvItem i) {
        if(n.getID() == EXPERT) {
            ...
            case 1113: // FULL PANNING TRAY
                ...
                p.message("The expert hands the tray back to you");
                break;
            ...
            case 1174: // stone tablet - QUEST COMPLETION!!
                ...
                if(p.getQuestStage(Plugin.DIGSITE) == 6) {
                    ...
                    addItem(p, 172, 2);
                    p.sendQuestComplete(Plugin.DIGSITE);
                }
                break;
            default:
