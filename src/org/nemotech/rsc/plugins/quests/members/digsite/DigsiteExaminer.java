        ...
        if(n.getID() == EXAMINER) {
            if(cID == -1) {
                ...
                case 0:
                    ...
                    if(menu == 0) {
                        ...
                        p.updateQuestStage(Plugin.DIGSITE, 1);
                    } else if(menu == 1) {
                ...
                case 1:
                    ...
                    if(hasItem(p, STAMPED_LETTER)) {
                        ...
                        p.updateQuestStage(Plugin.DIGSITE, 2);
            ...
            case ExaminerNPC.START_EXAM_FINAL:
                ...
                if(p.getCache().hasKey("student_orange_c") 
                    ...
                    setQuestStage(p, Plugin.DIGSITE, 3);
            ...
            case ExaminerNPC.START_EXAM2_FINAL:
                ...
                if(p.getCache().hasKey("student_orange_exam2") 
                    ...
                    setQuestStage(p, Plugin.DIGSITE, 4);
            ...
            case ExaminerNPC.START_EXAM3_FINAL:
                ...
                if(p.getCache().hasKey("student_orange_exam3") 
                    ...
                    setQuestStage(p, Plugin.DIGSITE, 5);
                } else {
                    if(CORRECT_ANSWERS == 0) {
