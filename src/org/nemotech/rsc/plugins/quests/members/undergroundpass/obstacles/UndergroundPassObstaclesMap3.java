...
import org.nemotech.rsc.model.landscape.Area;
import org.nemotech.rsc.model.landscape.Areas;
                        ...
                        try {
                            while (true) {
                                ...
                                Point blastPosition = new Point(
                                        Util.random(area.getMinX(), area.getMaxX()),
                                        Util.random(area.getMinY(), area.getMaxY()));
                                p.getSender().sendTeleBubble(blastPosition.getX(), blastPosition.getY(), true);
