...
public class UndergroundPassKoftik implements QuestInterface, TalkToNpcListener, TalkToNpcExecutiveListener {
    ...
    /** Quest NPCs **/
    /** Note: King Lathas (Quest starter) is located in the Biohazard quest template **/
    ...
    public int getQuestID() {
        return Plugin.UNDERGROUND_PASS;
    }
    ...
    public void handleReward(Player p) {
        ...
        p.incQuestExp(AGILITY, (p.getMaxStat(AGILITY) * 100) + 450);
        ...
        if(n.getID() == KOFTIK_FIRE_CAMP) {
            ...
            case 2:
                ...
                if(menu == 0) {
                    ...
                    message(p, "@dre@it seems to be written by the adventurer Randas, it reads...",
                            "@dre@It began as a whisper in my ears. Dismissing the sounds...",
                            "@dre@..as the whistling of the wind, I steeled myself against...",
                            "@dre@..these forces and continued on my way",
                            "@dre@But the whispers became moans...",
                            "@dre@at once fearsome and enticing like the call of some beautiful siren",
                            "@dre@Join us! The voices cried, Join us!",
                            "@dre@Your greatness lies within you, but only Zamorak can unlock your potential..");
    ...
    public static void koftikEnterCaveDialogue(Player p, NPC n) {
        ...
        p.updateQuestStage(Plugin.UNDERGROUND_PASS, 2);
        int menu = showMenu(p,n,
