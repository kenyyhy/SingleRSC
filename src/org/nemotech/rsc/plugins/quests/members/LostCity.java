...
import static org.nemotech.rsc.plugins.Plugin.PRAYER;
import static org.nemotech.rsc.plugins.Plugin.WOODCUTTING;
import static org.nemotech.rsc.plugins.Plugin.addItem;
import static org.nemotech.rsc.plugins.Plugin.atQuestStage;
import static org.nemotech.rsc.plugins.Plugin.atQuestStages;
...
import static org.nemotech.rsc.plugins.Plugin.getQuestStage;
import static org.nemotech.rsc.plugins.Plugin.getWoodcutAxe;
import static org.nemotech.rsc.plugins.Plugin.hasItem;
import static org.nemotech.rsc.plugins.Plugin.inArray;
import static org.nemotech.rsc.plugins.Plugin.isNpcNearby;
import static org.nemotech.rsc.plugins.Plugin.isWielding;
import static org.nemotech.rsc.plugins.Plugin.kill;
...
import static org.nemotech.rsc.plugins.Plugin.setCurrentLevel;
    ...
    public void onObjectAction(GameObject obj, String command, Player p) {
        ...
        case 245:
            if (atQuestStages(p, this, 4, 3, 2, -1)) {
                if (getCurrentLevel(p, WOODCUTTING) < 36) {
                    message(p,
                    ...
                    if(spawnedTreeSpirit != null) {
                        if (spawnedTreeSpirit.getAttribute("spawnedFor") != null) {
                            ...
                            if (spawnedTreeSpirit.getAttribute("spawnedFor").equals(p)) {
                                spawnedTreeSpirit.setChasing(p);
                                return;
                            }
                        }
                    }
                ...
                message(p, "You attempt to chop the tree");
                NPC treeSpirit = spawnNpc(216, p.getX() + 1, p.getY() + 1, 300000);
                if (treeSpirit == null) {
                    return;
                }
                sleep(2000);
                treeSpirit.setChasing(p);
