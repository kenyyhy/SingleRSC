...
import static org.nemotech.rsc.plugins.Plugin.transform;
...
InvUseOnObjectExecutiveListener, DropListener, DropExecutiveListener {
    ...
    public void onWallObjectAction(GameObject obj, Integer click, Player p) {
        if (obj.getX() == 277 && obj.getY() == 632) {
            if(p.getQuestStage(this) != 3 && !p.getCache().hasKey("lady_test")) {
                ...
                if(beggar == null) {
                    beggar = spawnNpc(286, 276, 631, 60000);
                }
                sleep(600);
                if(beggar != null) {
    ...
    public void onDrop(Player p, InvItem i) {
        ...
        if (opt == 1) {
            ...
            p.informOfNPCMessage(new ChatMessage(n, "rarrrrgh", p));
            n.startCombat(p);
        }
    }
    ...
    public void onTalkToNpc(Player p, NPC n) {
        if (n.getID() == 275 && !p.getLocation().inVarrock()) {
            switch (p.getQuestStage(Plugin.THE_HOLY_GRAIL)) {
            case 1:
            case 2:
            case 3:
            case 5:
                ...
                if(hasItem(p, 746)) {
                    ...
                    removeItem(p, 746, 1);
                    p.sendQuestComplete(Plugin.THE_HOLY_GRAIL);
                } else {
                    ...
                    if(p.getQuestStage(Plugin.THE_HOLY_GRAIL) == 1) {
            ...
            case 4:
                ...
                if (option == 0) {
                    ...
                    if (p.getQuestStage(this) == 0) {
                        p.updateQuestStage(Plugin.MERLINS_CRYSTAL, 1);
                    }
                } else if (option == 1) {
                    npcTalk(p, n,
            ...
            case 5:
                ...
                p.sendQuestComplete(Plugin.MERLINS_CRYSTAL);
                break;
            case -1:
                ...
                if (q == 0) {
                    ...
                    if(startHoly == 0) {
                        ...
                        p.updateQuestStage(Plugin.THE_HOLY_GRAIL, 1);
                    } else if(startHoly == 1) {
            ...
            case 1:
                ...
                if (p.getCache().hasKey("talked_to_gawain")) {
                    ...
                    if (opt == 0) {
                        ...
                        p.updateQuestStage(Plugin.MERLINS_CRYSTAL, 2);
