package org.nemotech.rsc.plugins.quests.members.grandtree;
...
public class GrandTree implements QuestInterface, TalkToNpcListener, TalkToNpcExecutiveListener, ObjectActionListener, ObjectActionExecutiveListener, PlayerAttackNpcListener, PlayerAttackNpcExecutiveListener, PlayerKilledNpcListener, PlayerKilledNpcExecutiveListener, InvUseOnObjectListener, InvUseOnObjectExecutiveListener {
    ...
    public void handleReward(Player p) {
        ...
        p.incQuestExp(16, (300 * p.getMaxStat(16)) + 400); // AGILITY
        p.incQuestExp(6, (50 * p.getMaxStat(6)) + 150); // MAGIC
        p.incQuestExp(0, (300 * p.getMaxStat(0)) + 400); // ATTACK
        ...
        if(n.getID() == KING_NARNODE_SHAREEN_UNDERGROUND) { // FINALE COMPLETION
            ...
            case 16:
                ...
                if(hasItem(p, 931)) {
                    ...
                    p.sendQuestComplete(Plugin.GRAND_TREE);
