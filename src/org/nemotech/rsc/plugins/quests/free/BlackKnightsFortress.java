...
public class BlackKnightsFortress implements QuestInterface,TalkToNpcListener,
    ...
    private static final Point DOOR_LOCATION = Point.getLocation(271, 441);
    private static final Point DOOR2_LOCATION = Point.getLocation(275, 439);
    private static final Point DOOR3_LOCATION = Point.getLocation(278, 443);

    @Override
    public int getQuestID() {
        return Plugin.BLACK_KNIGHTS_FORTRESS;
    }
    ...
    private void handleSirAmikVarze(final Player p, final NPC n) {
        ...
        case 3:
            ...
            p.sendQuestComplete(Plugin.BLACK_KNIGHTS_FORTRESS);
            break;
                ...
                if (guard != null) {
                    ...
                    if (option == 1) {
                        if (player.getX() <= 274) {
                            ...
                            if (knight != null) {
                                player.informOfNPCMessage(new ChatMessage(knight, "DIE INTRUDER!!", player));
