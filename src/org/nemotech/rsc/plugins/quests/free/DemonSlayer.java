            ...
            case 2:
                if (p.getCache().hasKey("tquest")) {
                    ...
                    while (p.getInventory().countId(20) > 0) {
                        p.getInventory().remove(new InvItem(20));
                    ...
                    if (boneCount >= 25) {
                        ...
                        p.getInventory().add(new InvItem(25, 1));
    ...
    private void sirPrysinDialogue(Player p, NPC n, int cID) {
        if (cID == -1) {
            ...
            case 3:
                ...
                break;
            case -1:
                if (p.getBank().contains(new InvItem(52))
                        || p.getInventory().contains(new InvItem(52))) {
                    npcTalk(p, n,
        ...
        if (n.getID() == 35) {
            ...
            case 3:
                if (!p.getInventory().wielding(52)) {
                    ...
                    n.setCurHits(n.getDef().getHitpoints());
                    p.resetMenuHandler();
                    p.lastOption = -1;
            ...
            if(p.inCombat()) {
                ...
                if(choice != -1) {
                    if (choice == 3) {
                        ...
                        n.killedBy(p);
                        n.remove();
                        if(p.getQuestStage(Plugin.DEMON_SLAYER) != -1) {
