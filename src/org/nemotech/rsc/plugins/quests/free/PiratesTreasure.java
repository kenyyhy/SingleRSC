...
InvUseOnObjectListener, InvUseOnObjectExecutiveListener {
    ...
    public int getQuestID() {
        return Plugin.PIRATES_TREASURE;
    }
        ...
        if (cID == -1) {
            if (!p.getCache().hasKey("bananas")) {
                ...
                if (p.getCache().getInt("bananas") >= 10) {
                    ...
                    p.getInventory().add(new InvItem(10, 30));
                    if(p.getCache().hasKey("bananas")) {
        ...
        case 185:
            if (p.getCache().hasKey("rum_delivered")) {
                if (p.getCache().getBoolean("rum_delivered")) {
                    ...
                    p.getInventory().add(new InvItem(318));
                    //
                ...
                if (wantabanana == 0) {
                    p.getInventory().add(new InvItem(249));
    ...
    public void onInvAction(InvItem item, Player p) {
        ...
        if ((p.getY() == 548 && p.getX() >= 287 && p.getX() <= 291)
            ...
            if (p.getX() == 290 || p.getX() == 289) {
                ...
                boolean dig = false;
                if (wysin != null) {
                    p.informOfNPCMessage(new ChatMessage(wysin, "Hey leave off my flowers", p));
