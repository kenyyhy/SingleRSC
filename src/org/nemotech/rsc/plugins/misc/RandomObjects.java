...
public class RandomObjects extends Plugin implements ObjectActionExecutiveListener, ObjectActionListener {
    ...
    public void onObjectAction(final GameObject object, String command,
        ...
        case 613: // Shilo cart
            ...
            if(owner.getX() >= 386) {
                ...
                owner.message("...to the other and climb down again.");
                return;
            }
            if(owner.getQuestStage(Plugin.SHILO_VILLAGE) != -1) {
            ...
            if(menu == 0) {
                ...
                owner.message("And climb down again");
            } else if(menu == 1) {
        ...
        if(object.getID() == 450) {
            ...
            if(owner.getQuestStage(Plugin.BIOHAZARD) == -1) {
