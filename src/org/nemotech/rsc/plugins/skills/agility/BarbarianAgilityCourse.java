    ...
    public void onObjectAction(GameObject obj, String command, Player p) {
        ...
        switch(obj.getID()) {
            ...
            case SWING:
                ...
                sleep(1000);
                int swingDamage = (int) Math.round((p.getCurStat(3)) * 0.15D);
                if(fail) {
                ...
                break;
            case LOG:
                int slipDamage = (int) Math.round((p.getCurStat(3)) * 0.1D);
            ...
            case LEDGE:
                ...
                int ledgeDamage = (int) Math.round((p.getCurStat(3)) * 0.15D);
                if(fail) {
